;(function ($, window, document, undefined) {
    ...
    var VariationForm = function ($form) {
        ...
        self.$form = $form;
        self.$attributeFields = $form.find('.variations select'); // Target <select> elements
        self.$customButtons = $form.find('.custom-color-button, .custom-button');
        ...
        $form.on('change.wc-variation-form', '.variations button', { variationForm: self }, self.onChange);
        ...
        self.$customButtons.on('click', function (e) {
            e.preventDefault();
            var $button = $(this);
            var attributeName = $button.data('variation-name'); // e.g., attribute_pa_color
            var attributeValue = $button.data('value'); // e.g., blue

            // Find the corresponding <select> element.
            var $select = self.$form.find('select[name="' + attributeName + '"]');
            // Add active class to the clicked button and remove from siblings.
            $button.addClass('active').siblings().removeClass('active');
            $form.trigger('change.wc-variation-form')
    ...
    VariationForm.prototype.onReset = function (event) {
        ...
        event.data.variationForm.$customButtons.removeClass('active');
        form.$resetVariations.css('visibility', 'hidden');
    };
    ...
    VariationForm.prototype.onUpdateAttributes = function (event) {
        ...
        form.$attributeFields.each(function (index, el) {
            ...
            // Enable or disable the corresponding custom buttons.
            form.$customButtons.each(function () {
                var $button = $(this);
                if ($button.data('variation-name') === attributeName) {
                    ...
                    if (!isEnabled) {
                        ...
                        form.$form.find('input[name="variation_id"], input.variation_id').val(0).trigger('change');
                    }
                }
            });
        });
